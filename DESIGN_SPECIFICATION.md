...
_This specification document serves as the single source of truth for CareerConnect's design system. All implementations should reference these guidelines for consistency._
