  ...
  return (
    <div className="flex flex-col justify-center items-center sm:min-h-screen overflow-y-auto">
      <div className="flex flex-col items-center gap-2 py-8">
        ...
        <p className="text-black/40 text-lg">{role === 'recruiter' ? 'Recruiter Portal' : 'Candidate Portal'}</p>
      </div>
      ...
      <div className="border border-gray-400 rounded-lg p-6 w-full max-w-sm shadow-lg mx-auto sm:max-w-md md:max-w-lg lg:max-w-xl">
        <form className="">
          <div className="flex flex-col gap-2">
            ...
            <p className="text-black/40">{role === 'recruiter' ? 'Sign in to your recruiter account' : 'Sign in to your candidate account'}</p>
          </div>
